...
function Notes() {
    ...
    const [disabledFlag2, setDisabledFlag2] = useState(false);
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="etitle" name='etitle' onChange={onChangeTitle}/>
                                </div>

                                <div className="mb-3">
                                    <label htmlFor="edescription" className="form-label">Description</label>
                                    <textarea name="edescription" id="edescription" className="form-control" rows="5" onChange={onChangeDescription}></textarea>
                                </div>
                        ...
                        <div className="modal-footer">
                            ...
                            disabled={(() => {
                                if(disabledFlag === false && disabledFlag2 === false){
                                    return false;
                                }
                                else{
                                    return true;
